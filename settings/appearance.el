...
;;
;; (set-face-attribute 'default nil :family "-PfEd-DejaVu Sans Mono-normal-normal-normal-*-21-*-*-*-m-0-iso10646-1")
;; (set-face-attribute 'default nil :size 21)
;; (set-face-attribute 'default nil :height 25)
;;
(provide 'appearance)
