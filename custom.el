...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (perspective undo-tree dash-functional magit-popup transient-0 flycheck-purescript psc-ide purescript-mode csharp-mode flymake-rust rust-playground rjsx-mode react-snippets company-go company-mode vue-html-mode vue-mode tide jsx-mode yaml-mode yafolding circe neotree kotlin-mode ac-haskell-process intero json-mode terraform-mode ac-c-headers flymake-cppcheck go-dlv auto-complete flymake-ruby rust-mode rustfmt go-add-tags go-autocomplete go-direx go-eldoc go-errcheck go-gopath go-impl go-mode go-playground go-rename go-scratch go-snippets go-stacktracer golint gotham-theme go-guru edn cider clojure-mode psci corral rspec-mode rinari exec-path-from-shell zencoding-mode zenburn-theme yesql-ghosts whitespace-cleanup-mode visual-regexp string-edit smartparens simple-httpd restclient prodigy paredit nodejs-repl move-text markdown-mode magit ido-vertical-mode ido-at-point htmlize highlight-escape-sequences handlebars-sgml-mode handlebars-mode guide-key groovy-mode gotest gist flycheck-pos-tip flycheck-clojure flx-ido fill-column-indicator elixir-yasnippets elixir-mode elisp-slime-nav dockerfile-mode dired-details css-eldoc clojure-mode-extra-font-locking abyss-theme)))
